...
print("Please wait while the site is being loaded.")
...
input("Please wait for the page to load completely and then press 'ENTER'.")

links = list(set([]))  # coverting to set as we dont require repeated links
